        ...
        <div className='flex justify-center items-center h-full'>
            <form className='shadow-lg p-10 rounded-md flex flex-wrap gap-3 max-w-3xl justify-between bg-white' onSubmit={handleSubmit(submit)}>
                <div className='flex flex-col w-full max-w-xs'>
                    ...
                    <input className='border border-1 border-gray-400 rounded-md p-1' type="text" id='model'{...register("model")} />
                </div>
                <div className='flex flex-col w-full max-w-xs'>
                    <label className='mb-2' htmlFor='image'>
                        Image
                    </label>
                    <input className='border border-1 border-gray-400 rounded-md p-1' type='text' name='image' id='image' {...register("image")} />
                </div>
                <div className='flex flex-col w-full max-w-xs'>
                    <label className='mb-3' htmlFor='brand'>
                        Brand
                    </label>
                    <select className='border border-1 border-gray-400 rounded-md p-1' name='brand' id='brand' {...register("brand")}>
                ...
                <div className='flex flex-col w-full max-w-xs'>
                    ...
                    <input className='border border-1 border-gray-400 rounded-md p-1' type='text' name='price' id='price' {...register("price")} />
                </div>
                ...
                <div className='flex flex-col w-full max-w-xs'>
                    ...
                    <input className='border border-1 border-gray-400 rounded-md p-1'
                        type='text'
                        name='keyFeature1'
                        id='keyFeature1'
