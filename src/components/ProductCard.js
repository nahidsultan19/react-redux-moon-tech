    ...
    return (
        <div className='shadow-lg rounded-3xl border  p-3 flex flex-col text-indigo-900'>
            ...
            <div className='flex gap-2 mt-5'>
                {pathname.includes('cart') && <button className='bg-red-500 flex justify-between items-center px-3 rounded-full py-1 px-2 flex-1 text-white text-bold' onClick={() => dispatch(removeFromCart(product))}>
